...
/**
 * This is basic Kununu WebTestCase class for functional tests.
 * It provides the basic setup and also GET and POST requests.
 */
class KununuWebTestCase extends WebTestCase
{
    /**
